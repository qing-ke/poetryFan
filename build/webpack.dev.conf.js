...
let sentences1 = appData.sentences1
...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    ...
    before(app){
      app.get('/api/sentences1', (req, res) => {
        res.json({
          // 这里是你的json内容
          error: 0,
          data: sentences1
      ...
      app.get('/api/sentences2', (req, res) => {
        res.json({
          // 这里是你的json内容
          error: 0,
          data: sentences2
      ...
      app.get('/api/sentences3', (req, res) => {
        res.json({
          // 这里是你的json内容
          error: 0,
          data: sentences3
      ...
      app.get('/api/sentences4', (req, res) => {
        res.json({
          // 这里是你的json内容
          error: 0,
          data: sentences4
